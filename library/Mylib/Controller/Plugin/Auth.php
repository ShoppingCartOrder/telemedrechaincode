...
class Mylib_Controller_Plugin_Auth extends Mylib_Controller_Plugin_Base
{
    ...
    public function preDispatch(Zend_Controller_Request_Abstract $request)
    {
        ...
        if ($this->isRoute('admin')) {
            ...
            $userNamespace = new Zend_Session_Namespace('mylaboratory');
            $request->setParam('laboratory', true);
            
        }else if ($this->isRoute('nurse')) {
            $userNamespace = new Zend_Session_Namespace('mynurse');
            $request->setParam('nurse', true);
