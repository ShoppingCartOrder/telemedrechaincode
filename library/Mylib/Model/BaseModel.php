...
class Mylib_Model_BaseModel extends Zend_Db_Table_Abstract
{
    ...
    public function __construct()
    {
        ...
        $myNurseUserSession = new Zend_Session_Namespace('mynurse');
        ...
        $this->nurseUserSession = $myNurseUserSession->storage;
        ...
        if(isset($this->nurseUserSession->id)){
            
            $this->modelNurseLoginId = $this->nurseUserSession->id; 
            $this->modelNurseId = $myNurseUserSession->nurse_id; 
