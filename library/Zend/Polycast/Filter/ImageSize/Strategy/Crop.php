 ...
 */
require_once 'Zend/Polycast/Filter/ImageSize/Strategy/Interface.php';

/**
 * Strategy for resizing the image so that its smalles edge fits into the frame.
 * The rest is cropped.
 */
class Zend_Polycast_Filter_ImageSize_Strategy_Crop 
    implements Zend_Polycast_Filter_ImageSize_Strategy_Interface
{
    /**
