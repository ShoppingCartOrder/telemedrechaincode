 ...
 */
class Zend_Polycast_Filter_ImageSize_PathBuilder_Standard implements Zend_Polycast_Filter_ImageSize_PathBuilder_Interface
{
    /**
     ...
     * @return string
     */
    public function buildPath($filename, Zend_Polycast_Filter_ImageSize_Configuration_Interface $config)
    {
