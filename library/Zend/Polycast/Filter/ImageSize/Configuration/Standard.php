...
class Zend_Polycast_Filter_ImageSize_Configuration_Standard implements Zend_Polycast_Filter_ImageSize_Configuration_Interface 
{
    /**
     ...
     * @var string
     */
    protected $_overwriteMode = Zend_Polycast_Filter_ImageSize::OVERWRITE_NONE;
    ...
    public function getStrategy()
    {
        if (null === $this->_strategy) {
            $this->_strategy = new Zend_Polycast_Filter_ImageSize_Strategy_Fit();
        }
     ...
     * @return Polycast_Filter_ImageSize_Configuration_Interface Fluent interface
     */
    public function setStrategy(Zend_Polycast_Filter_ImageSize_Strategy_Interface $strategy)
    {
