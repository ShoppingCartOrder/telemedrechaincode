...
/**
 * @see Zend_Polycast_Filter_ImageSize_Strategy_Fit
 */
require_once 'Zend/Polycast/Filter/ImageSize/Strategy/Fit.php';

/**
 * @see Zend_Polycast_Filter_ImageSize_PathBuilder_Interface
 */
require_once 'Zend/Polycast/Filter/ImageSize/PathBuilder/Interface.php';

/**
 * @see Zend_Polycast_Filter_ImageSize_PathBuilder_Standard
 */
require_once 'Zend/Polycast/Filter/ImageSize/PathBuilder/Standard.php';

/**
 * @see Zend_Polycast_Filter_ImageSize_Configuration_Standard
 */
require_once 'Zend/Polycast/Filter/ImageSize/Configuration/Standard.php';
 ...
 */
class Zend_Polycast_Filter_ImageSize implements Zend_Filter_Interface
{
    /**
    ...
    /** @var Zend_Polycast_Filter_ImageSize_PathBuilder_Interface */
    protected $_pathBuilder = null;

    /** @var Zend_Polycast_Filter_ImageSize_Configuration_Interface */
     ...
     * Constructor.
     */
    public function __construct(Zend_Polycast_Filter_ImageSize_Configuration_Interface $config = null)
    {
     ...
     * on first call.
     * 
     * @return Zend_Polycast_Filter_ImageSize_Configuration_Interface
     */
    public function getConfig()
    {
        if (null === $this->_config) {
            $this->_config = new Zend_Polycast_Filter_ImageSize_Configuration_Standard();
        }
        return $this->_config;
    }
     ...
     * configuration.
     * 
     * @param Zend_Polycast_Filter_ImageSize_Configuration_Interface $configSet
     */
    public function setConfig(Zend_Polycast_Filter_ImageSize_Configuration_Interface $config)
    {
        $this->_config = $config;
    }
    
    /**
     * Returns the Zend_Polycast_Filter_ImageSize_PathBuilder_Interface instance
     * used to build the path of output files.
     * 
     * @return Zend_Polycast_Filter_ImageSize_PathBuilder_Interface
     */
    public function getOutputPathBuilder()
    {
        if (null === $this->_pathBuilder) {
            $this->_pathBuilder = new Zend_Polycast_Filter_ImageSize_PathBuilder_Standard('./');
        }
        return $this->_pathBuilder;
    }
    
    /**
     * Sets the Zend_Polycast_Filter_ImageSize_PathBuilder_Interface instance used
     * to build the path of output files.
     * 
     * @param Zend_Polycast_Filter_ImageSize_PathBuilder_Interface $pathBuilder
     * @return Zend_Polycast_Filter_ImageSize
     */
    public function setOutputPathBuilder(Zend_Polycast_Filter_ImageSize_PathBuilder_Interface $pathBuilder)
    {
    ...
    protected function _checkWritePermissions()
    {
        if ($this->getConfig()->getOverwriteMode() == self::OVERWRITE_NONE) {
            ...
            if (file_exists($outputPath)) {
                throw new Zend_Filter_Exception('Can\'t create thumbnail. File already exists: ' . $outputPath . '. Use $this->getConfig()->setOverrideMode(Zend_Polycast_Filter_ImageSize::OVERWRITE_ALL) to allow overriding existing files.');
            }
        }
    }
