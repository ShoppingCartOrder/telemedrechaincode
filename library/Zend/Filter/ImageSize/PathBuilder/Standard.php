 ...
 */
class Zend_Filter_ImageSize_PathBuilder_Standard implements Zend_Filter_ImageSize_PathBuilder_Interface
{
    /**
     ...
     * 
     * @param type $filename
     * @param Zend_Filter_ImageSize_Configuration_Interface $config
     * @return string
     */
    public function buildPath($filename, Zend_Filter_ImageSize_Configuration_Interface $config)
    {
