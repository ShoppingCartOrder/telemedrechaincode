...
class Zend_Filter_ImageSize_Configuration_Standard implements Zend_Filter_ImageSize_Configuration_Interface 
{
    /**
     ...
     * @var string
     */
    protected $_overwriteMode = Zend_Filter_ImageSize::OVERWRITE_NONE;
     ...
     * @return Zend_Filter_ImageSize_Configuration_Interface Fluent interface
     */
