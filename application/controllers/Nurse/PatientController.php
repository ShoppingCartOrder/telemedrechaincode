...
class Nurse_PatientController extends Mylib_Controller_NursebaseController {
    ...
    public function indexAction() {
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            $params['sidx'] = 'a.id';
            $params['sord'] = 'DESC';
            $params['userRoleType'] = NURSE_ROLE;

            $result = $this->_patientResource->allTypePatientList($params);
            //dd($result);
            ...
            foreach ($result['result'] as $k => $val) {
                ...
                if($val['test_count'] == 0){
                    ...
                    $testURL = NURSE_BASE_URL.'labtest-requests/view/patient_id/'.$id.'/rid/'.$rId.'/appntid/'.$appointmentId.'/id/'.$prescriptionId;
                ...
                if($prescriptionId){
                    ...
                    $dpURL = NURSE_BASE_URL.'doctor-prescribe/addedit/patient_id/'.$id.'/rid/'.$rId.'/appntid/'.$appointmentId.'/id/'.$prescriptionId;
                ...
                if($investigationId){
                    ...
                    $hiURL = NURSE_BASE_URL.'investigation/addedit/patient_id/'.$id.'/rid/'.$rId.'/appntid/'.$appointmentId.'/prescribe_id/'.$prescriptionId.'/id/'.$investigationId;
                    $hiname = 'View Investigation';
