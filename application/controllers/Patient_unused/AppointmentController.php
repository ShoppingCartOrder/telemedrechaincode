...
class Patient_AppointmentController extends Mylib_Controller_PatientbaseController {
    ...
    public function init() {
        ...
        $this->_departmentResource = new Application_Model_DbTable_Speciality();
    }
       ...
       global $arrPatientType;
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            foreach ($result['result'] as $k => $val) {
                ...
                $actionUpdate = "<a onclick='return patientEdit($id,$apType);' href='javascript:void(0);'><img width='15' height='15' src='".WEBSITE_Image."/view.png' alt='View' title='View'></a>";               
//                if($val['status'] == 1){
