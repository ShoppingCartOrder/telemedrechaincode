    ...
    public function medicalReportDetailsAddeditAction() {
        ...
        if (!empty($loginId)) {
            ...
            $formdata = array(
                ...
                'hash_medical_report_filename' => $prescriptionData['hash_medical_report_filename'],
            ...
            if ($inputData->isValid()) {
                    ...
                    if ((($ext == "pdf") || ($ext == "jpg") || ($ext == "jpg")) && ($_FILES["medical_report_filename"]["size"] < 500000000)) {
                        ...
                        if (!move_uploaded_file($_FILES['medical_report_filename']['tmp_name'], $newname)) {
                            ...
                            //echo "<pre>$output5</pre>"; 
                             ...
                             //$output3 = shell_exec('ipfs add /var/www/html/public/info.php');
                            //echo "<pre>$output3</pre>"; 
                            
                             //$output4 = shell_exec("ipfs add $newname"); 
                            ...
                            //echo "<pre>$output</pre>"; die;
                             ...
                             //$output = shell_exec("/home/ubuntu sudo su ipfs add $newname 2>&1"); 
                             //$output = shell_exec("/home/ubuntu sudo su ipfs add chk_srv.php 2>&1"); 
                            
                            
                            //$output = shell_exec("php /var/www/html/public/test_i.php 2>&1"); 
                            
                            
                             //$output = shell_exec("ipfs add $newname 2>&1"); 
                            //$output = shell_exec("php test_i.php 2>&1"); 
                            
                            //echo "<pre>Hello</pre>"; 
                            //echo "<pre>$output</pre>"; 
                            
                            //echo "<pre>Hiii</pre>"; die;
                            ...
                            chdir(PUBLIC_PATH); */
                            /*IPFS Code[Start Here]*/
                            
                            // chdir('/home/kumar_roushan');
                            
                            $output1 = shell_exec('ls'); 
                            //dd($output1);
                            //$output2 = shell_exec('ipfs init 2>&1');
                            //dd($output2);
                            //$output5 = shell_exec('ipfs daemon');
                            
                            $hashFileName = '';
                            if(IPFS_DEBUG_MODE){
                                $output4 = shell_exec("ipfs add $newname 2>&1"); 
                                dd($output4);
                                $arrHash = explode(' ',$output4);
                                $hashFileName = $arrHash[6];
                            }else{
                                $output4 = shell_exec("ipfs add $newname"); 
                                $arrHash = explode(' ',$output4);
                                $hashFileName = $arrHash[1];
                            }
                            
                           
                            $logFileName = str_replace('.'.$ext, '.txt', $newfilename);
                            $fwrite = $this->createAndWriteFile(UPLOAD_LOG_FILE_PATH.$logFileName,$output4); 
                            
                            if ($fwrite === false) {
                               $this->_helper->FlashMessenger()->setNamespace('error')->addMessage('Not written in file.');
                               $this->_redirect(PATIENT_BASE_URL . 'health/medical-report-details-addedit/id/' . $id);
                            }
                ...
                if (!empty($id)) {
                    ...
                    $prescriptionData = array(
                        ...
                        'hash_medical_report_filename'=> $output4,
                        'note' => $params['note'],
                    ...
                    if ($newfilename != '') {
                        ...
                        $prescriptionData['hash_medical_report_filename'] = $hashFileName;
...
//dd($formdata);
            ...
            if ($inputData->isValid()) {
                ...
                if (!empty($id)) {
                    ...
                    $vitalData = array(
                        ...
                        'pulse' => $params['pulse'],
                        'spo2' => $params['spo2'],
                        'created_by' => $this->patientNamespace->patient_id
    ...
    protected function validateVitalData($data, $errMsg) {
        ...
        if (isset($data['heart_beat'])) {
            $this->validators['heart_beat'] = array(
                'NotEmpty',
                'messages' => array('Please enter heart beat.'));
        }
        if (isset($data['pulse'])) {
            $this->validators['pulse'] = array(
                'NotEmpty',
                'messages' => array('Please enter pulse.'));
        }
    }
