...
class Patient_DashboardController extends Mylib_Controller_PatientbaseController {
       ...
       global $nowDateTime;
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            foreach ($result['result'] as $k => $val) {
                ...
                $doctorImgPath = WEBSITE_STATIC_IMAGE_PATH.'doctor1.jpg';
                $doctorImg = "<img alt = 'Doctor photo' src='$doctorImgPath' style='border-radius:50%'/>";
                
                $doctorAddLink = PATIENT_BASE_URL.'dashboard/doctor-location/address/'.$val['address'];
                
                $videoAppmtLink = PATIENT_BASE_URL.'appointment/video-consultation-addedit';
                $txtAppmtLink = PATIENT_BASE_URL.'appointment/text-consultation-addedit';
                $clinicAppmtLink = PATIENT_BASE_URL.'appointment/clinic-consultation-addedit';
                $consultationLink = "<a title = 'Click here to video consultation' target = '_blank' href='$videoAppmtLink'><span class='fa fa-video-camera' aria-hidden='true'></span>&nbsp;Video</a><br/>"
                        . "<a title = 'Click here to text consultation' target = '_blank' href='$txtAppmtLink'><span class='fa fa-comments' aria-hidden='true'></span>&nbsp;Text</a><br/>"
                        . "<a title = 'Click here to clinic consultation' target = '_blank' href='$clinicAppmtLink'><span class='fa fa-hospital-o' aria-hidden='true'></span>&nbsp;Clinic</a>"
                        . "";
                $doctorAddress = "<a title = 'Click here to get location' target = '_blank' href='$doctorAddLink'>".$val['address']."</a>";
...
//dd($responce,true);
	...
	public function doctorLocationAction() {
