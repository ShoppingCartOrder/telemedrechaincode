       ...
       //global $appointmentType;
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            foreach ($result['result'] as $k => $val) {
               ...
               $actionUpdate = "<a title = 'Edit Prescription' onclick='return prescriptionEdit($did,$appntId,$id);' href='javascript:void(0);'><span class='far fa-edit' aria-hidden='true'></span></a>";
