       ...
       global $nowDateTime;
        ...
        if ($request->isXmlHttpRequest()) {
            ...
            foreach ($result['result'] as $k => $val) {
                ...
                $patientLinkUrl = DOCTOR_BASE_URL.'health/medical-report-details/patient_id/'.$val['id'];
                //$medRpLink = ;
               $actionUpdate = "<a href='$patientLinkUrl' title = 'Medical Test Report' target ='_blank'>Medical Report</a>";               
//                if($val['status'] == 1){
