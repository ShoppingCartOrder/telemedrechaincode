...
class Doctor_PrescriptionController extends Mylib_Controller_DoctorbaseController {
                ...
                if (!empty($pid) && !empty($appntId) && !empty($id)) {
                   ...
                   $patientData = array(                         
                    ...
                    if (($updateP)) {
                        ...
                        $this->_redirect(DOCTOR_BASE_URL . 'prescription/index');
                        ...
                        $this->_redirect(DOCTOR_BASE_URL . 'prescription/addedit/patient_id/'.$pid.'/appnt_id/'.$appntId.'/id/'.$id);
                   ...
                   $patientData = array(                         
                    ...
                    $insertedId = $this->_prescriptionResource->addPrescription($patientData);
                            ...
                            if ($insertedId) {
                                ...
                                $this->_redirect(DOCTOR_BASE_URL . 'prescription/addedit/patient_id/'.$pid.'/appnt_id/'.$appntId);
