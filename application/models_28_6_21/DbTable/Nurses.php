 ...
 */
class Application_Model_DbTable_Nurses extends Mylib_Model_BaseModel {

    /**
     * Defining class variable for users table name.
     */
    protected $_name = 'hms_nurses';
    ...
    public function getNurseByEmail($email) {
     ...
     public function fetchNurseById($id) {
...
public function updateNurseData($dbdata, $id) {
        $where['id =?'] = $id;
        return $this->getAdapter()->update($this->_name, $dbdata, $where);
    }
    
     public function allNurses($params = null)
    {
        if (empty($params))
            return false;
...
//echo $selectCount; die;
    ...
    public function getUserDetails($id) {
     ...
     public function getNurseLoginIdByNurseId($id) {
        try{
     ...
     public function updateNurseDetail($dbdata, $data) {
        $where['id =?'] = $data;
        return $this->getAdapter()->update($this->_name, $dbdata, $where);
    }
    
     public function fetchNurseProfileData($id) {
