...
class Laboratory_IndexController extends Mylib_Controller_LaboratorybaseController {
    ...
    public function indexAction() {
        ...
        if ($request->isPost()) {
            ...
            if ($this->_process(array('username' => $request->getParam('username'), 'password' => $request->getParam('password')))) {
                ...
                $this->_redirect(LABORATORY_BASE_URL . 'dashboard/index');
            }
            //  }
            $this->_redirect(LABORATORY_BASE_URL . 'index/login/s/1');
        } else {
    ...
    protected function _process($values) {
        ...
        $objRequest->setParam('laboratory', true);
        $objRequest->setParam('userRoleType', LABORATORY_ROLE);
    ...
    public function logoutAction() {
        ...
        $this->_redirect(LABORATORY_BASE_URL . 'login'); // back to login page
