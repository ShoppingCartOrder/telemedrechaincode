        ...
        if ($request->isXmlHttpRequest()) {
            ...
            foreach ($result['result'] as $k => $val) {
                ...
                if($val['test_count'] == 0){
                    ...
                    $testURL = NURSE_BASE_URL.'labtest-requests/view/patient_id/'.$id.'/rid/'.$rId.'/id/'.$prescriptionId;
                ...
                if($investigationId){
                    ...
                    $hiURL = NURSE_BASE_URL.'investigation/addedit/patient_id/'.$id.'/rid/'.$rId.'/prescribe_id/'.$prescriptionId.'/id/'.$investigationId;
