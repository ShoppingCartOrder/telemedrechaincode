...
class Nurse_IndexController extends Mylib_Controller_NursebaseController {
    ...
    public function indexAction() {
        ...
        if ($request->isPost()) {
            ...
            $session = new Zend_Session_Namespace('mynurse');
            ...
            if ($this->_process(array('username' => $request->getParam('username'), 'password' => $request->getParam('password')))) {
                ...
                $this->_redirect(NURSE_BASE_URL . 'dashboard/index');
            }
            //  }
            $this->_redirect(NURSE_BASE_URL . 'index/login/s/1');
    ...
    protected function _process($values) {
        ...
        $objRequest->setParam('nurse', true);
        $objRequest->setParam('userRoleType', NURSE_ROLE);
