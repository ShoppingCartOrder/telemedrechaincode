...
define('LABORATORY_BASE_URL',HOSTPATH.'laboratory/');
define('NURSE_BASE_URL',HOSTPATH.'nurse/');

define('ADMIN_ROLE', 3);
define('DOCTOR_ROLE', 2);
define('PATIENT_ROLE', 1);
define('LABORATORY_ROLE', 4);
...
define('DEFAULT_PASSWORD',"bidhan");
...
$arrBloodGroup = array('a+' =>'A+','a-'=>'A-','b+'=>'B+','b-'=>'B-','ab+'=>'AB+','ab-'=>'AB-','o+'=>'O+','o-'=>'O-');
$arrRelation = array('so' =>'S/O','wo'=>'W/O','ho'=>'H/O','mo'=>'M/O');
$arrMatrialStatus = array('1' =>'Married','2'=>'Unmarried');
$arrPaymentMethod = array('1' =>'Cash');
$arrLabRequestStatus = array('0' =>'Pending','1'=>'Completed');
define('LAB_REQUEST_STATUS',":All;0:Pending;1:Completed");
$arrPatientType = array('1' =>'OPD','2'=>'IPD');
define('PAID_APPOINTMENT_VALID_DAYS','20 days');
$titleType = array('Mr.' =>'Mr.','Mrs.'=>'Mrs.','Miss'=>'Miss','Ms'=>'Ms'); 
define('UPLOAD_LAB_TEST_REPORT_FILE_PATH',PUBLIC_PATH.'/lab-test-reoprts/');
define('UPLOADED_LAB_TEST_REPORT_FILE_PATH',WEBSITE_PUBLIC_URL.'lab-test-reoprts/');
